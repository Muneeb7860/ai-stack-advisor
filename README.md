...
Both refine and ask are grounded against a 20-domain use-case knowledge base (two-stage hybrid
...
backend/                       v2 — FastAPI + Postgres + Alembic
  ...
  tests/                         1,373 tests — see backend/README.md for the breakdown
